...
const juce::Colour ER1Colours::defaultBackground(0xff555555); // Dark Grey
const juce::Colour ER1Colours::defaultForeground(0xff999999); // Lighter Grey
...
//const juce::Colour ER1Colours::padUp(0xffeddebc);
